...
class monthly_statement_line(models.Model):
	...
	_name = 'payments.statement.invoice'
	_description = "Payments Statement Line"
	_order = "date"

	date = fields.Date('Date')
	invoice_number = fields.Char('INV')
	account = fields.Char('ACC')
	ref = fields.Char('REF')
	invoices_debit = fields.Float('Debit')
	payments_credit = fields.Float('Credit')
	balance = fields.Float('Bal')
